...
public class FileUtils
{
	 ...
	 * @return
	 */
	public static  boolean createDirectory1(String directoryName) {
		boolean status;
		boolean d = isExist(Environment.getExternalStorageDirectory() + "/ZJMZ");
		if (!directoryName.equals("")&&!d) {
			File path = Environment.getExternalStorageDirectory();
			String path1 = path.toString() +"/"+ directoryName;
